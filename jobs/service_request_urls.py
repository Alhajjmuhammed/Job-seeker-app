...
worker_urlpatterns = [
    ...
    path('service-requests/<int:pk>/detail/', worker_views.worker_service_request_detail, name='worker_service_request_detail'),
...
client_urlpatterns = [
    ...
    path('service-requests/<int:pk>/rate/', client_views.client_rate_service, name='client_rate_service'),
