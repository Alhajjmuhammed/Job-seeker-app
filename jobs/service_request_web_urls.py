...
urlpatterns = [
    ...
    path('client/request/<int:pk>/edit/', client_web.client_web_edit_request, name='client_edit_request'),
    path('client/request/<int:pk>/cancel/', client_web.client_web_cancel_request, name='client_cancel_request'),
    path('client/request/<int:pk>/complete/', client_web.client_web_complete_request, name='client_complete_request'),
    path('client/request/<int:pk>/upload-screenshot/', client_web.client_web_upload_screenshot, name='client_upload_screenshot'),
    path('client/request/<int:pk>/activity/', client_web.client_web_activity, name='client_request_activity'),
