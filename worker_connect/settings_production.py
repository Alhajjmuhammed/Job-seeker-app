"""
Production settings for Worker Connect
Import this in production: export DJANGO_SETTINGS_MODULE=worker_connect.settings_production
"""

from .settings import *
import os

# SECURITY CRITICAL SETTINGS FOR PRODUCTION
DEBUG = False
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'workerconnect'),
...
# Static and Media Files (Use CDN or S3 in production)
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')
STATICFILES_STORAGE = 'django.contrib.staticfiles.storage.ManifestStaticFilesStorage'

# Media Files - Configure S3 or similar
...
# Admin Notifications
ADMINS = [
    ('Admin', os.environ.get('ADMIN_EMAIL', 'admin@workerconnect.com')),
]
MANAGERS = ADMINS
