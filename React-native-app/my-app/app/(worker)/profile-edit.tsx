...
export default function ProfileEditScreen() {
  ...
  const handleUseCurrentLocation = async () => {
    try {
      ...
      if (status !== 'granted') {
        Alert.alert(t('common.error'), 'Location permission denied. You can still fill in your address manually.');
        return;
      }
    ...
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.section, { backgroundColor: theme.surface, shadowColor: isDark ? '#000' : '#000', shadowOpacity: isDark ? 0.3 : 0.1 }]}>
          ...
          <TouchableOpacity
            style={[styles.useLocationButton, { borderColor: theme.primary }]}
          ...
          >
            ...
            <Text style={[styles.useLocationButtonText, { color: theme.primary }]}>
              {latitude !== null ? 'Location captured ✓ - Tap to refresh' : 'Use my current location'}
            </Text>
          </TouchableOpacity>
