...
export default function WorkerProfileScreen() {
  ...
  useEffect(() => {
    if (user && user.userType !== 'worker') {
      ...
      // (client)/profile doesn't exist - the client route group's home is dashboard
    ...
    <View style={{ flex: 1, backgroundColor: theme.background }}>
      ...
      >
        ...
        <View style={[styles.section, { backgroundColor: theme.surface, borderColor: theme.border }]}>
          ...
          <TouchableOpacity
            style={[styles.menuItem, { borderBottomColor: theme.divider }]}
            onPress={() => router.push('/(worker)/cv' as any)}
          >
            <Ionicons name="person-circle-outline" size={24} color={theme.primary} />
            <Text style={[styles.menuText, { color: theme.text }]}>My CV</Text>
            <Text style={[styles.menuArrow, { color: theme.textTertiary }]}>›</Text>
          </TouchableOpacity>
          <TouchableOpacity
        ...
        <View style={[styles.section, { backgroundColor: theme.surface, borderColor: theme.border }]}>
          ...
          <TouchableOpacity 
            style={[styles.menuItem, { borderBottomColor: theme.divider }]}
            onPress={() => router.push('/(worker)/support' as any)}
          >
