...
export default function SupportScreen() {
  ...
  const handleContactSupport = async () => {
    ...
    try {
      ...
      Alert.alert(
        t('common.error'),
        'Failed to submit your support request. Please check your connection and try again.'
      );
    } finally {
      setSubmitting(false);
    }
  ...
  const handleEmailSupport = () => {
    Linking.openURL('mailto:sales@easyfix.co.tz?subject=Support Request');
  };
          ...
          <View style={[styles.formCard, { backgroundColor: theme.surface }]}>
            ...
            >
              ...
              <Text style={styles.submitButtonText}>
                {submitting ? t('common.loading') : t('support.sendMessageButton')}
              </Text>
            </TouchableOpacity>
          </View>
        </View>
