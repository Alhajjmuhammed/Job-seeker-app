...
export default function ActiveService() {
  ...
  const loadCurrentAssignment = async () => {
    try {
      setLoading(true);
      // getCurrentAssignment() hits the paginated /my-assignments/?status=in_progress
      // list endpoint (worker_my_assignments), which returns
      // { results: [...] } via paginate_queryset - not a single
